public class MD5 {
	...
	private void MainLoop(int M[]) {
		...
		for (int i = 0; i < 64; i++) {
            ...
            System.out.println("new f: " + (a + F + K[i] + M[g]));
            System.out.println("shift: " + shift(a + F + K[i] + M[g], s[i]));
			a = tmp;
	...
	public String getMD5(String source) {
        ...
        for (int j = 0; j < strByte.length; j++ )
            System.out.println("str by: " +strByte[j] + " : " + j);
	...
	public static void main(String[] args) {
        ...
        //message = "";
	    System.out.println(inst.getMD5(message));
	}
